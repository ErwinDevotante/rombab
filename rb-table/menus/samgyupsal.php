        ...
        <div class="card-columns-container">
            <?php 
                $result_tb = mysqli_query($connection, "SELECT * FROM `menus`
                            WHERE menu_category = 'Samgyupsal' AND menu_availability = '0'");
                            ...
                            while ($row = mysqli_fetch_array($result_tb)) { ?> 
                                <form action="" method="post">
                                    <div class="card p-2 mb-2 card-red text-center">
                                        ...
                                        <button type="submit" class="btn btn-md btn-outline-danger text-white w-100 mt-1" name="add_to_cart">ADD TO CART <i class="bi bi-cart-plus-fill"></i></button>
                                    </div>
                                </form>
                            <?php }
                        }  ?>
