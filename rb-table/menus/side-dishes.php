        ...
        <div class="row">
            ...
            <?php 
                $result_tb = mysqli_query($connection, "SELECT * FROM menus
                                        WHERE menu_category = 'Side Dishes' ");
                    while ($row = mysqli_fetch_array($result_tb)) { ?> 
                        <div class="card card-body card-red text-center mb-2">
                            ...
                            <div class="add-btn"><button class="btn btn-md btn-outline-danger text-white w-100 mt-1">ADD</button></div>
                        </div>
                    <?php }  ?>
            </div>
        </div>
