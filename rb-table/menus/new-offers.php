...
<body class="bg-black">
    ...
    <div class="container-fluid text-center p-1 text-white">
      <h1 class="highlight header-colorize text-uppercase text-white">NEW OFFERS MENU</h1>
    </div>

    <div class="container py-5">
      <div class="card-columns-container">
        <?php
          $result_tb = mysqli_query($connection, "SELECT * FROM `menus` WHERE menu_category = 'New Offers'");
          ...
          <form action="" method="post" onsubmit="rememberScrollPosition()">
            <div class="card p-2 mb-2 card-red text-center position-relative">
              ...
              <div class="productname bg-white text-black rounded-bottom">
                <h5 class="text-truncate text-uppercase"><?php echo $row["menu_name"]; ?> - ₱<?php echo number_format($row["menu_price"], 2); ?></h5>
              </div>
